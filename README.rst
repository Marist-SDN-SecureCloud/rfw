...
To run an instance of the rfw API with docker you can either create your own image based off the Dockerfile located in the root of the directory of the `repository <https://github.com/Marist-SDN-SecureCloud/rfw>`_ or pull and use the image in 
`Docker Hub <https://hub.docker.com/r/dgisolfi/lcars_rfw/>`_. If this is your first time using Docker and need to install the program, refer to the following guide otherwise you may skip to Deploying the API

Installing Docker
-----------------

*The following is an installation guide for Docker and on a Ubuntu host machine for guides on other distros and operating systems refer to* `here <https://docs.docker.com/install/>`__ 
